...
from PhoenixGUI import Ui_PhoenixUi
...
class MainThread(QThread):
        ...
        try:
            ...
            with sr.Microphone() as source:
                ...
                command1 = listener.recognize_google(voice,
                                                     language='en-in')  # Convert voice to text using Google's speech recognition
                command1 = command1.lower()  # Convert the recognized text to lowercase for easier processing

                if 'phoenix' in command1:  # Check if the command contains the word 'jarvis'
                    command1 = command1.replace('phoenix', '')  # Remove 'phoenix' from the command for better accuracy
    ...
    def run_phoenix(self):
        self.wish()
        self.talk('Hello boss I am phoenix your AI assistant. Please tell me how can I help you?')
        while True:
            ...
            if ('play a song' in self.command) or ('youtube' in self.command) or (
                ...
                self.OnlineClasses(self.command)
                    ...
                    'open amrita portal' in self.command) or ('open octave' in self.command):
            ...
            elif ("recording" in self.command) or ("screen recording" in self.command) or (
                    "voice recording" in self.command):
                try:
            ...
            elif ('tell me news' in self.command) or ("tell me today's news" in self.command) or (
                    "the news" in self.command) or ("todays news" in self.command):
    ...
    def Fun(self, command):
        ...
        if 'your name' in command:
            self.talk("My name is phoenix")
        elif 'my name' in command:
            self.talk("your name is Shiva")
        elif 'university name' in command:
            self.talk("you are studing in SR University, Btech Computer Science ")
    ...
    def social(self, command):
        ...
        if 'facebook' in command:
            ...
            webbrowser.open('https://twitter.com/shivavanam7')
    ...
    def shedule(self):
        ...
        Week = {
            ...
            "thursday": "6:00 AM - Wake up, shower, and get dressed 7:00 AM - Breakfast 8:00 AM - Work/school 12:00 PM - Lunch break 1:00 PM - Work/school 5:00 PM - Commute back home 6:00 PM - Socialize with friends/family 8:00 PM - Dinner 9:00 PM - Watch a movie or go to a concert/show 11:00 PM - Wind down and prepare for bed 12:00 AM - Sleep",
    ...
    def college(self, command):
        ...
        elif 'sr portal' in command:
            self.talk('opening your sr university portal')
            webbrowser.open('https://sraap.in/')
    ...
    def OnlineClasses(self, command):
        ...
        if ("python" in command):
            ...
            webbrowser.open("https://teams.microsoft.com/python")
    ...
    def open_source(self, command):
        ...
        if 'github' in command:
            ...
            webbrowser.open('hhttps://github.com/VANAM-SHIVA-KUMAR/PHOENIX-Python-Voice-Assistant')
    ...
    def CloseApp(self, command):
        print(command)
        if ('calculator' in command):
            self.talk("okay boss, closing calculator")
    ...
    def pdf_reader(self):
        ...
        self.talk("please enter the page number which I need to read for you")
...
class Main(QMainWindow):
    ...
    def __init__(self, path):
        self.cpath = path
        super().__init__()
        self.ui = Ui_PhoenixUi()  # (path=current_path)
...
Phoenix = Main(path=current_path)
Phoenix.show()
exit(app.exec_())
