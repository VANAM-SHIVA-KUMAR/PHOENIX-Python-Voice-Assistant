...
Visit our Website - [https://vanam-shiva-kumar.github.io/PHOENIX-Python-Voice-Assistant](https://vanam-shiva-kumar.github.io/PHOENIX-Python-Voice-Assistant)
...
# Introduction 👨‍💻
It is a voice assistant which can be used to interact with your computer and also you have been seeing it in Iron man movies, but this PHOENIX is not that much advanced as shown in movies. 
...
- You need to first ```fork``` this repository and ```clone``` the repository to your local system 
    ...
    ```git clone https://github.com/<your-github-username>/PHOENIX-Python-Voice-Assistant.git```
...
I have already made some good first issues and easy issues in the issue section. You can start contributing from there. You can also add new fucntionality to our PHOENIX nad make it more smart.😎
